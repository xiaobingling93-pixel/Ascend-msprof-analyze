...
from timeline_advice.torch_sche_advice import TorchScheAdvice
from timeline_advice.cann_sche_advice import CannScheAdvice

class TimelineAdviceFactory(AdviceFactory):
    ADVICE_LIB = {
        Constant.OPTIM: OptimizerAdvice,
        Constant.TORCH_SCHE: TorchScheAdvice,
        Constant.CANN_SCHE: CannScheAdvice
    }
